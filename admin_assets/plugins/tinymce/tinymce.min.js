...
(function (e, t) {
    ...
    r(l, [], function () {
        ...
        return S = a.compile = function (e, t) {
            ...
            return o
        }, N.pseudos.nth = N.pseudos.eq, x.prototype = N.filters = N.pseudos, N.setFilters = new x, z.sortStable = F.split("").sort(K).join("") === F, B(), [0, 0].sort(K), z.detectDuplicates = G, "function" == typeof r && r.amd ? r(function () {
            return a
        }) : window.Sizzle = a, a
        ...
        function n(r) {
            ...
            function S(e, t) {
                var n, r, o, a, s, l;
                if (t != F && (n = i()), r = A(e, t), n && n.appendChild(r), o = G(e), a = o - D[V], 0 >= a) return t != I && (D.setEndBefore(e), D.collapse(z)), n;
            ...
            function T(e, t) {
                var n, r, o, a, s, l;
                for (t != F && (n = i()), o = B(e, t), n && n.appendChild(o), r = G(e), ++r, a = D[$] - r, o = e.nextSibling; o && a > 0;) s = o.nextSibling, l = H(o, t), n && n.appendChild(l), --a, o = s;
                return t != I && (D.setStartAfter(e), D.collapse(W)), n
            }
            function R(e, t, n) {
                var r, o, a, s, l, c, u, d;
                for (n != F && (o = i()), r = B(e, n), o && o.appendChild(r), a = e.parentNode, s = G(e), l = G(t), ++s, c = l - s, u = e.nextSibling; c > 0;) d = u.nextSibling, r = H(u, n), o && o.appendChild(r), u = d, --c;
        ...
        return c.prototype = {
            ...
            getParents: function (e, n, r, i) {
                var o = this,
                    a, s = [];
                for (e = o.get(e), i = i === t, d(n, "string") && (a = n, n = "*" === n ? function (e) {
                    return 1 == e.nodeType
                } : function (e) {
                    return o.is(e, a)
                ...
                return this.run(e, function (e) {
                    ...
                    if (n) if ("string" == typeof n) {
                            o = e.style, n = n.replace(/-(\D)/g, function (e, t) {
                                return t.toUpperCase()
                            }), "number" != typeof r || b[n] || (r += "px"), "opacity" === n && e.runtimeStyle && e.runtimeStyle.opacity === t && (o.filter = "" === r ? "" : "alpha(opacity=" + 100 * r + ")");
                            try {
                                o[n] = r
                            } catch (s) {}
            ...
            function d(e) {
                ...
                if (e) for (e = t(e, ","), v["@"] && (w = v["@"].attributes, _ = v["@"].attributesOrder), n = 0, r = e.length; r > n; n++) if (s = E.exec(e[n])) {
                            ...
                            if (f) for (f = t(f, "|"), o = 0, a = f.length; a > o; o++) if (s = S.exec(f[o])) {
                                        if (d = {}, m = s[1], h = s[2].replace(/::/g, ":"), C = s[3], k = s[4], "!" === m && (c.attributesRequired = c.attributesRequired || [], c.attributesRequired.push(h), d.required = !0), "-" === m) {
                                        ...
                                        C && ("=" === C && (c.attributesDefault = c.attributesDefault || [], c.attributesDefault.push({
                                            ...
                                            name: h,
                                            value: k
                                        }), d.forcedValue = k), "<" === C && (d.validValues = i(k, "?"))), T.test(h) ? (c.attributePatterns = c.attributePatterns || [], d.pattern = u(h), c.attributePatterns.push(d)) : (g[h] || y.push(h), g[h] = d)
                                    }
            ...
            function p(e) {
                ...
                e && o(t(e, ","), function (e) {
                    var t = n.exec(e),
                        ...
                        i = r ? "span" : "div",
                        a = t[2];
                    y[a] = y[i], R[a] = i, r || (E[a.toUpperCase()] = {}, E[a] = {}), v[a] || (v[a] = v[i]), o(y, function (e) {
                        e[i] && (e[a] = e[i])
                    })
                })
            }
        ...
        return function (n, i) {
            ...
            n = n || {}, o.schema = i = i || new e, n.fix_self_closing !== !1 && (n.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var a = this,
                    s, l = 0,
                    c, u, d = [],
                    f, p, h, m, g, v, y, b, C, x, w, _, N, k, E, S, T, R, A, B, L, H, M, D, P, O = 0,
                    I = t.decode,
                    F;
                for (H = RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), M = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, y = i.getShortEndedElements(), L = n.self_closing_elements || i.getSelfClosingElements(), b = i.getBoolAttrs(), x = n.validate, v = n.remove_internals, F = n.fix_self_closing, D = i.getSpecialElements(); s = H.exec(e);) {
                    if (s.index > l && a.text(I(e.substr(l, s.index - l))), c = s[6]) c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), r(c);
                        ...
                        if (c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), C = c in y, F && L[c] && d.length > 0 && d[d.length - 1].name === c && r(c), !x || (w = i.getElementRule(c))) {
                            if (_ = !0, x && (E = w.attributes, S = w.attributePatterns), (k = s[8]) ? (g = -1 !== k.indexOf("data-mce-type"), g && v && (_ = !1), f = [], f.map = {}, k.replace(M, o)) : (f = [], f.map = {}), x && !g) {
                ...
                if (a = a || {}, h = {}, m = {}, R = l(o("script,style,head,html,body,title,meta,param"), c.getBlockElements()), I = c.getNonEmptyElements(), O = c.children, T = i.validate, F = "forced_root_block" in a ? a.forced_root_block : i.forced_root_block, P = c.getWhiteSpaceElements(), A = /^[ \t\r\n]+/, H = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, D = /^[ \t\r\n]+$/, y = new r({
                    ...
                    start: function (e, t, n) {
                        ...
                        if (o = T ? c.getElementRule(e) : {}) {
                            for (r = d(o.outputName || e, 1), r.attributes = t, r.shortEnded = n, C.append(r), s = O[C.name], s && O[r.name] && !s[r.name] && B.push(r), i = p.length; i--;) a = p[i].name, a in t.map && (E = m[a], E ? E.push(r) : m[a] = [r]);
    ...
    }), r(E, [v, _, m, k, C, x, g, p], function (e, t, n, r, i, o, a, s) {
        var l = s.each,
            c = s.trim,
            u = e.DOM;
        return function (e, i) {
        ...
        return function (i, o) {
            ...
            function s(t) {
                var n, r;
                n = t.screenX - k, r = t.screenY - E, H = n * N[2] + R, M = r * N[3] + A, H = 5 > H ? 5 : H, M = 5 > M ? 5 : M, (e.modifierPressed(t) || "IMG" == x.nodeName && 0 !== N[2] * N[3]) && (H = Math.round(M / B), M = Math.round(H * B)), b.setStyles(w, {
                    width: H,
                    height: M
            ...
            function c(e, n, r) {
                var i, c, d, f, p;
                i = b.getPos(e, o.getBody()), S = i.x, T = i.y, p = e.getBoundingClientRect(), c = p.width, d = p.height, x != e && (g(), x = e, H = M = 0), f = o.fire("ObjectSelected", {
                    target: e
                }), a(e) && !f.isDefaultPrevented() ? C(_, function (e, i) {
                    function a(t) {
                        L = !0, k = t.screenX, E = t.screenY, R = x.clientWidth, A = x.clientHeight, B = A / R, N = e, w = x.cloneNode(!0), b.addClass(w, "mce-clonedresizable"), w.contentEditable = !1, w.unSelectabe = !0, b.setStyles(w, {
                            left: S,
                            top: T,
                            margin: 0
        ...
        function a(e, t, i, o) {
            var a = this;
            a.dom = e, a.win = t, a.serializer = i, a.editor = o, a.controlSelection = new r(a, o), o.on("nodechange", function () {
                var e;
                e = o.getDoc().selection ? o.getDoc().selection.createRange() : a.getRng(), a.lastRng = e
        ...
        return a.prototype = {
            ...
            destroy: function () {
                this.win = this.lastRng = null, this.controlSelection.destroy()
            }
        }, a
    }), r(B, [p], function (e) {
        function n(e) {
        ...
        return function (i) {
            ...
            function d(e, t) {
                e && ("string" != typeof e ? et(e, function (e, t) {
                    ...
                    e.deep === Y && (e.deep = !e.selector), e.split === Y && (e.split = !e.selector || e.inline), e.remove === Y && e.selector && !e.inline && (e.remove = "none"), e.selector && e.inline && (e.mixed = !0, e.block_expand = !0), "string" == typeof e.classes && (e.classes = e.classes.split(/\s+/))
                }), O[e] = t))
            }
            function f(e) {
                var t;
            ...
            function h(n, r, a) {
                function l(e, t) {
                    t = t || g, e && (t.onformat && t.onformat(e, t, r, a), et(t.styles, function (t, n) {
                        ...
                        t = k(t, r), I.hasClass(e, t) || I.addClass(e, t)
                    }))
                }
                function c() {
                    function t(t, n) {
                ...
                function d(e, n, r, i, o) {
                    ...
                    }), 0 >= s || s > c && u > s ? (et(tt(e.childNodes), o), 0) : (d = I.clone(r, G), et(tt(e.childNodes), function (e, t) {
                ...
                function f(e, i, a) {
                    ...
                    u = g.inline || g.block, f = I.create(u), l(f), W.walk(e, function (e) {
                        function h(e) {
                            var b, x, w, N, k;
                            return k = p, b = e.nodeName.toLowerCase(), x = e.parentNode.nodeName.toLowerCase(), 1 === e.nodeType && J(e) && (k = p, p = "true" === J(e), N = !0), _(b, "br") ? (y = 0, g.block && I.remove(e), t) : g.wrapper && v(e, n, r) ? (y = 0, t) : p && !N && g.block && !g.wrapper && o(b) && z(x, u) ? (e = I.rename(e, u), l(e), c.push(e), y = 0, t) : g.selector && (et(m, function (t) {
                        ...
                        function o(e) {
                            ...
                            }), n && w(n, g) && (r = I.clone(n, G), l(r), I.replace(r, e, K), I.remove(n, 1)), r || e
                        }
                        var a;
                        ...
                        if (g.inline || g.wrapper) {
                            ...
                            }), v(e.parentNode, n, r)) return I.remove(e, 1), e = 0, K;
                ...
                if (g) if (a) a.nodeType ? (b = I.createRng(), b.setStartBefore(a), b.setEndAfter(a), f(T(b, m), null, !0)) : f(a, null, !0);
                    ...
                    U || !m[0].defaultBlock || I.getParent(x, I.isBlock) || h(m[0].defaultBlock), i.selection.setRng(c()), y = F.getBookmark(), f(T(F.getRng(K), m), y), g.styles && (g.styles.color || g.styles.textDecoration) && (nt(x, p, "childNodes"), p(x)), F.moveToBookmark(y), P(F.getRng(K)), i.nodeChanged()
                }
            }
            function m(e, n, r) {
                function o(e) {
                ...
                function p(e) {
                    var t, n;
                    e = T(e, h, K), m.split && (t = M(e, K), n = M(e), t != n ? (/^(TR|TD)$/.test(t.nodeName) && t.firstChild && (t = "TD" == t.nodeName ? t.firstChild || t : t.firstChild.firstChild || t), t = S(t, "span", {
                        id: "_start",
                        "data-mce-type": "bookmark"
                    }), n = S(n, "span", {
                        id: "_end",
                        "data-mce-type": "bookmark"
                    }), c(t), c(n), t = d(K), n = d()) : t = n = c(t), e.startContainer = t.parentNode, e.startOffset = q(t), e.endContainer = n.parentNode, e.endOffset = q(n) + 1), W.walk(e, function (e) {
                        et(e, function (e) {
            ...
            function x(e, n, r) {
                var o;
                return X || (X = {}, o = {}, i.on("NodeChange", function (e) {
                    var n = a(e.element),
                        r = {};
                    et(X, function (e, i) {
                        et(n, function (a) {
                    ...
                    X[e] || (X[e] = [], X[e].similar = r), X[e].push(n)
                }), this
            }
            function w(e, n) {
            ...
            function T(n, r, s) {
                ...
                function c(e, t) {
                    for (t === Y && (t = 3 === e.nodeType ? e.length : e.childNodes.length); e && e.hasChildNodes();) e = e.childNodes[t], e && (t = 3 === e.nodeType ? e.length : e.childNodes.length);
                    return {
                        node: e,
                        offset: t
                    }
            ...
            function R(e, n, r, i) {
                ...
                if ("all" != e.remove) for (et(e.styles, function (e, t) {
                        e = k(e, n), "number" == typeof t && (t = e, i = 0), (!i || _(N(i, t), e)) && I.setStyle(r, t, ""), s = 1
                        ...
                        e = k(e, n), (!i || I.hasClass(i, e)) && I.removeClass(r, e)
                    }), a = I.getAttribs(r), o = 0; a.length > o; o++) if (0 !== a[o].nodeName.indexOf("_")) return G;
                return "none" != e.remove ? (A(r, e), K) : t
            }
            function A(e, t) {
                function n(e, t, n) {
                ...
                })) : V(e) && !V(r) && (n(e, G) || n(e.firstChild, K, 1) || e.insertBefore(I.create("br"), e.firstChild), n(e, K) || n(e.lastChild, G, 1) || e.appendChild(I.create("br")))), t.selector && t.inline && !_(t.inline, e) || I.remove(e, 1)
            }
            function B(e, t, n) {
                if (e) for (t = t ? "nextSibling" : "previousSibling", e = n ? e : e[t]; e; e = e[t]) if (1 == e.nodeType || !E(e)) return e
            }
            function L(e) {
            ...
            function H(e, t) {
                function n(e, t) {
                    ...
                    return e.nodeName != t.nodeName ? G : r(n(e), n(t)) ? r(I.parseStyle(I.getAttrib(e, "style")), I.parseStyle(I.getAttrib(t, "style"))) ? K : G : G
                }
                function r(e, t) {
                    for (i = e; i; i = i[t]) {
            ...
            function P(n) {
                var r = n.startContainer,
                    i = n.startOffset,
                    o, a, s, l, c;
                if (3 == r.nodeType && i >= r.nodeValue.length && (i = q(r), r = r.parentNode, o = !0), 1 == r.nodeType) for (l = r.childNodes, r = l[Math.min(i, l.length - 1)], a = new e(r, I.getParent(r, I.isBlock)), (i > l.length - 1 || o) && a.next(), s = a.current(); s; s = a.next()) if (3 == s.nodeType && !E(s)) return c = I.create("a", null, $), s.parentNode.insertBefore(c, s), n.setStart(s, 0), F.setRng(n), I.remove(c), t
            }
            var O = {}, I = i.dom,
                F = i.selection,
                W = new n(I),
            ...
            function i(i) {
                ...
                function v(e, t) {
                    ...
                    if (i = o.getParent(e, o.isBlock), u = n.getBody().nodeName.toLowerCase(), !i || !d(i)) {
                        if (i = i || E, !i.hasChildNodes()) return r = o.create(f), i.appendChild(r), N.setStart(r, 0), N.setEnd(r, 0), r;
                ...
                function y() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (O = "LI"), L = O ? m(O) : o.create("BR"), e(!0) && e() ? "LI" == n ? o.insertAfter(L, t()) : o.replace(L, M) : e(!0) ? "LI" == n ? (o.insertAfter(L, t()), L.appendChild(o.doc.createTextNode(" ")), L.appendChild(M)) : M.parentNode.insertBefore(L, M) : e() ? (o.insertAfter(L, t()), f(L)) : (M = t(), k = N.cloneRange(), k.setStartAfter(R), k.setEndAfter(M), H = k.extractContents(), o.insertAfter(H, M), o.insertAfter(L, M)), o.remove(R), h(L), l.add()
                }
                function b() {
                ...
                if (!i.isDefaultPrevented() && (S = N.startContainer, T = N.startOffset, O = (s.force_p_newlines ? "p" : "") || s.forced_root_block, O = O ? O.toUpperCase() : "", A = o.doc.documentMode, B = i.shiftKey, 1 == S.nodeType && S.hasChildNodes() && (I = T > S.childNodes.length - 1, S = S.childNodes[Math.min(T, S.childNodes.length - 1)] || S, T = I && 3 == S.nodeType ? S.nodeValue.length : 0), E = w(S))) {
                    if (l.beforeChange(), !o.isBlock(E) && E != o.getRoot()) return (!O || B) && C(), t;
        ...
        return function (n) {
            ...
            o(this, {
                ...
                mceInsertLink: function (e, t, n) {
                    ...
                    "string" == typeof n && (n = {
                        href: n
                    }), r = x.getParent(w.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || k.remove("link"), n.href && k.apply("link", n, r)
                },
                selectAll: function () {
                    var e = x.getRoot(),
                        t = x.createRng();
        ...
        var r = e.extend({
            ...
            renderHtml: function () {
                var e = this,
                    n = e._layout,
                    r = e.settings.html;
                return e.preRender(), n.preRender(e), r === t ? r = '<div id="' + e._id + '-body" class="' + e.classes("body") + '">' + n.renderHtml(e) + "</div>" : ("function" == typeof r && (r = r()), e._hasBody = !1), '<div id="' + e._id + '" class="' + e.classes() + '" hideFocus="1" tabIndex="-1">' + (e._preBodyHtml || "") + r + "</div>"
            }
        });
        return r
    }), r(K, [z], function (e) {
            ...
            s, l = e.extend({
                ...
                init: function (e) {
                    function t() {
                        ...
                        n ? r.css(i, "z-index", n.zIndex - 1) : i && (i.parentNode.removeChild(i), s = !1), l.currentZIndex = t
                    }
                    function n(e, t) {
                        for (; e;) {
                            if (e == t) return !0;
                    ...
                    var c = this;
                    c._super(e), c._eventsRoot = c, c.addClass("floatpanel"), e.autohide && (i || (i = function (e) {
                        var t, r = c.getParentCtrl(e.target);
                        for (t = o.length; t--;)(!r || !n(r, o[t]) && o[t].parent() !== r) && o[t].hide()
                    }, r.on(document, "click", i)), o.push(c)), c.on("postrender show", function (e) {
                        if (e.control == c) {
                            ...
                            c.modal && !s && (n = r.createFragment('<div id="' + i + 'modal-block" class="' + i + "reset " + i + 'fade"></div>'), n = n.firstChild, c.getContainerElm().appendChild(n), setTimeout(function () {
                                r.addClass(n, i + "in"), r.addClass(c.getEl(), i + "in")
                            }, 0), s = !0), a.push(c), t()
                        }
                    }), c.on("close hide", function (e) {
                        if (e.control == c) {
    ...
    }), r(Q, [Y, G, z, J, $], function (e, n, r, i, o) {
        var a = e.extend({
            modal: !0,
            Defaults: {
                border: 1,
            ...
            recalc: function () {
                var e = this,
                    n = e.statusbar,
                    i, o, a;
                return e._fullscreen && (e.layoutRect(r.getWindowSize()), e.layoutRect().contentH = e.layoutRect().innerH), e._super(), i = e.layoutRect(), e.settings.title && !e._fullscreen && (o = i.headerW, o > i.minW && (i.minW = i.w = o + (i.w - i.innerW), i.innerW = i.w - i.deltaW, a = !0)), n && (n.layoutRect({
                    w: e.layoutRect().innerW
                }).recalc(), o = n.layoutRect().minW + i.deltaW, o > i.minW && (i.minW = i.w = o, i.innerW = i.w - i.deltaW, a = !0)), a ? (e.recalc(), t) : t
            },
            initLayoutRect: function () {
                var e = this,
                    t = e._super(),
            ...
            renderHtml: function () {
                var e = this,
                    ...
                    s = "",
                    l = o.html;
                return e.preRender(), n.preRender(e), o.title && (a = '<div id="' + r + '-head" class="' + i + 'window-head">' + '<div class="' + i + 'title">' + o.title + "</div>" + '<button type="button" class="' + i + 'close" aria-hidden="true">&times;</button>' + '<div id="' + r + '-dragh" class="' + i + 'dragh"></div>' + "</div>"), o.url && (l = '<iframe src="' + o.url + '" tabindex="-1"></iframe>'), l === t && (l = n.renderHtml(e)), e.statusbar && (s = e.statusbar.renderHtml()), '<div id="' + r + '" class="' + e.classes() + '" hideFocus="1" tabIndex="-1">' + a + '<div id="' + r + '-body" class="' + e.classes("body") + '">' + l + "</div>" + s + "</div>"
            },
        ...
        return function (s) {
            ...
            var D = a.each,
                ...
                q = o.ie,
                $ = o.webkit;
            x(), k(), f(), M(), $ && (N(), d(), h(), v(), T(), o.iOS ? b() : p()), q && (m(), C(), w(), _(), A(), B(), L(), H()), U && (m(), g(), y(), E(), S(), R())
        }
    }), r(nt, [p], function (e) {
        function t() {
            return !1
    ...
    }), r(it, [v, b, C, E, k, A, L, H, M, D, P, O, y, l, et, x, _, tt, g, p, nt, rt], function (e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w) {
        function _(e, t) {
        ...
        return N.prototype = {
            render: function () {
                function e() {
                    ...
                    r.language && e.add(n.editorManager.baseURL + "/langs/" + r.language + ".js"), r.theme && "function" != typeof r.theme && "-" != r.theme.charAt(0) && !E.urls[r.theme] && E.load(r.theme, "themes/" + r.theme + "/theme" + o + ".js"), C.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), R(r.plugins.split(/[ ,]/), function (e) {
                ...
                var n = this,
                    ...
                    i = n.id,
                    o = n.suffix;
                if (!M.domLoaded) return k.bind(window, "ready", function () {
                        n.render()
                    }), t;
            ...
            init: function () {
                ...
                }), t.contentAreaContainer = l.iframeContainer, l.editorContainer && (k.get(l.editorContainer).style.display = t.orgDisplay), k.get(t.id).style.display = "none", k.setAttrib(t.id, "aria-hidden", !0), t.editorManager.relaxedDomain && c || t.initContentBody(), r = s = l = null
            },
            ...
            focus: function (e) {
                var t, n = this,
                    ...
                    o, a, s = n.getDoc(),
                    l;
                e || ((o = r.lastRng) && (r.lastRng = null, r.setRng(o), n.nodeChanged()), o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), i || n.getWin().focus(), (D || i) && (l = n.getBody(), l.setActive ? l.setActive() : l.focus(), i && r.normalize()), a && a.ownerDocument == s && (o = s.body.createControlRange(), o.addElement(a), o.select())), n.editorManager.activeEditor != n && ((t = n.editorManager.activeEditor) && t.fire("deactivate", {
                    relatedTarget: n
                }), n.fire("activate", {
                    relatedTarget: t
            ...
            save: function (e) {
                var n = this,
                    r = n.getElement(),
                    i, o;
                if (r && n.initialized) return e = e || {}, e.save = !0, e.element = r, i = e.content = n.getContent(e), e.no_events || n.fire("SaveContent", e), i = e.content, /TEXTAREA|INPUT/i.test(r.nodeName) ? r.value = i : (r.innerHTML = i, (o = k.getParent(n.id, "form")) && R(o.elements, function (e) {
    ...
    }), r(ot, [it, v, O, g, p, nt], function (e, n, r, i, o, a) {
        var s = n.DOM,
            l = o.explode,
            c = o.each,
            u = o.extend,
            ...
            f, p = {
                ...
                setup: function () {
                    ...
                    if (n = document.location.href.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(n) || (n += "/"), o = window.tinymce || window.tinyMCEPreInit) t = o.base || o.baseURL, i = o.suffix;
                            ...
                            var l = a[s].src;
                            if (/tinymce(\.jquery|)(\.min|\.dev|).js/.test(l)) {
                                -1 != l.indexOf(".min") && (i = ".min"), t = l.substring(0, l.lastIndexOf("/"));
                                break
                            }
                    }
                    e.baseURL = new r(n).toAbsolute(t), e.documentBaseURL = n, e.baseURI = new r(e.baseURL), e.suffix = i
                },
                init: function (t) {
                    function n(e) {
                        var t = e.id;
                        return t || (t = e.name, t = t && !s.get(t) ? e.name : s.uniqueId(), e.setAttribute("id", t)), t
                    }
                    function r(e, t, n) {
                        var r = e[t];
                    ...
                    var o = this,
                        a = [],
                        f;
                    o.settings = t, s.bind(window, "ready", function () {
                        var p, h;
                        switch (r(t, "onpageload"), t.mode) {
                        case "exact":
                            p = t.elements || "", p.length > 0 && c(l(p), function (n) {
                                s.get(n) ? (f = new e(n, t, o), a.push(f), f.render(!0)) : c(document.forms, function (r) {
                                    c(r.elements, function (r) {
                        ...
                        case "specific_textareas":
                            c(s.select("textarea"), function (r) {
                                t.editor_deselector && i(r, t.editor_deselector) || (!t.editor_selector || i(r, t.editor_selector)) && (f = new e(n(r), t, o), a.push(f), f.render(!0))
                            });
                            break;
                        default:
                            t.types ? c(t.types, function (r) {
                                c(s.select(r.selector), function (i) {
                                    var s = new e(n(i), u({}, t, r), o);
                                    a.push(s), s.render(1)
                                })
                            }) : t.selector && c(s.select(t.selector), function (r) {
                                var i = new e(n(r), t, o);
                                a.push(i), i.render(1)
                            })
                        }
                        t.oninit && (p = h = 0, c(a, function (e) {
                            h++, e.initialized ? p++ : e.on("init", function () {
                                p++, p == h && r(t, "oninit")
                            }), p == h && r(t, "oninit")
                        }))
                    })
                ...
                add: function (e) {
                    ...
                    return n[e.id] = e, n.push(e), t.activeEditor = e, t.fire("AddEditor", {
                        ...
                        t.fire("BeforeUnload")
                    }, s.bind(window, "beforeunload", f)), e
                },
                ...
                remove: function (e) {
                    ...
                    return t.activeEditor == e && (t.activeEditor = r[0]), e.destroy(), t.fire("RemoveEditor", {
                        editor: e
                    }), r.length || s.unbind(window, "beforeunload", f), e
                },
        ...
        return p.setup(), window.tinymce = window.tinyMCE = p, u(p, a), p
    }), r(at, [ot, p], function (e, t) {
        var n = t.each,
            r = t.explode;
    ...
    }), r(ft, [v, l, y, b, p, g], function (e, t, n, r, i, o) {
    ...
    }), r(Lt, [U, V, Y, p, ot], function (e, n, r, i, o) {
        function a(e, n) {
            function r(e) {
            ...
            var i, o, a = e.dom,
                s = "",
                c, u;
            return u = e.settings.preview_styles, u === !1 ? "" : (u || (u = "font-family font-size font-weight text-decoration text-transform color background-color border border-radius"), (n = e.formatter.get(n)) ? (n = n[0], i = n.block || n.inline || "span", o = a.create(i), l(n.styles, function (e, t) {
                e = r(e), e && a.setStyle(o, t, e)
            }), l(n.attributes, function (e, t) {
                e = r(e), e && a.setAttrib(o, t, e)
            }), l(n.classes, function (e) {
                e = r(e), a.hasClass(o, e) || a.addClass(o, e)
            }), e.fire("PreviewFormats"), a.setStyles(o, {
                position: "absolute",
                left: -65535
            }), e.getBody().appendChild(o), c = a.getStyle(e.getBody(), "fontSize", !0), c = /px$/.test(c) ? parseInt(c, 10) : 0, l(u.split(" "), function (t) {
                ...
                if (!("background-color" == t && /transparent|rgba\s*\([^)]+,\s*0\)/.test(n) && (n = a.getStyle(e.getBody(), t, !0), "#ffffff" == a.toHex(n).toLowerCase()) || "color" == t && "#000000" == a.toHex(n).toLowerCase())) {
                    if ("font-size" == t && /em|%$/.test(n)) {
                        if (0 === c) return;
                        n = parseFloat(n, 10) / (/%$/.test(n) ? 100 : 1), n = n * c + "px"
                    }
        ...
        return e.extend({
            recalc: function (e) {
                ...
                for (f = 0; n > f; f++) for (d = 0; r > d && (u = i[f * r + d], u); d++) c = u.layoutRect(), E = c.minW, S = c.minH, N[d] = E > N[d] ? E : N[d], k[f] = S > k[f] ? S : k[f];
                for (A = o.innerW - g.left - g.right, w = 0, d = 0; r > d; d++) w += N[d] + (d > 0 ? y : 0), A -= (d > 0 ? y : 0) + N[d];
                for (B = o.innerH - g.top - g.bottom, _ = 0, f = 0; n > f; f++) _ += k[f] + (f > 0 ? b : 0), B -= (f > 0 ? b : 0) + k[f];
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    for (h = g.top, f = 0; n > f; f++) {
                        for (p = g.left, s = k[f] + L, d = 0; r > d && (u = i[f * r + d], u); d++) m = u.settings, c = u.layoutRect(), a = N[d], T = R = 0, c.x = p, c.y = h, v = m.alignH || C, "center" == v ? c.x = p + a / 2 - c.w / 2 : "right" == v ? c.x = p + a - c.w : "stretch" == v && (c.w = a), v = m.alignV || x, "center" == v ? c.y = h + s / 2 - c.h / 2 : "bottom" == v ? c.y = h + s - c.h : "stretch" == v && (c.h = s), u.layoutRect(c), p += a + y, u.recalc && u.recalc();
                        h += s + b
                    }
            ...
            value: function (e) {
                ...
                if (e !== t) {
                    if (n.menu) n.menu.items().each(function (t) {
                            r = t.value() === e, r && (i = i || t.text()), t.active(r)
                        });
                    else for (o = n.settings.menu, a = 0; o.length > a; a++) r = o[a].value == e, r && (i = i || o[a].text), o[a].active = r;
                    n.text(i)
                }
                return n._super(e)
            }
        })
    }), r(Wt, [gt, U], function (e, t) {
        return e.extend({
            Defaults: {
                border: 0,
                role: "menuitem"
