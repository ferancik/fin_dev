...
<div class="row margin-bottom-20 stories-cont">
    <div class="col-lg-3 col-md-6">
        <div class="portlet light">
            <div class="photo">
                <img src="<?php echo base_url(); ?>/assets/pages/media/users/teambg1.jpg" alt="" class="img-responsive" /> </div>
            <div class="title">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="portlet light">
            <div class="photo">
                <img src="<?php echo base_url(); ?>/assets/pages/media/users/teambg2.jpg" alt="" class="img-responsive" /> </div>
            <div class="title">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="portlet light">
            <div class="photo">
                <img src="<?php echo base_url(); ?>/assets/pages/media/users/teambg5.jpg" alt="" class="img-responsive" /> </div>
            <div class="title">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="portlet light">
            <div class="photo">
                <img src="<?php echo base_url(); ?>/assets/pages/media/users/teambg8.jpg" alt="" class="img-responsive" /> </div>
            <div class="title">
                <span> Tom Brady </span>
            </div>
            <div class="desc">
...
<div class="row about-links-cont" data-auto-height="true">
    ...
    <div class="col-md-6 col-sm-12">
        <div class="about-image" style="background: url(<?php echo base_url(); ?>/assets/pages/media/works/img4.jpg) center no-repeat;"></div>
    </div>
</div>
<!-- END LINKS BLOCK -->
