...
$urlT = site_url('admin/spravajazykovweb/uprava/').'/?jazyk=' . $jazyk . '/' . substr($subor, 0, -4) . '';
...
<fieldset>  
    ...
    <?php foreach ($lang as $key => $value) { ?>
        <div class="row">
            <div class="span6">
                ...
                <textarea name="old_text_<?php echo $key; ?>"  class="span6" ><?php echo $langen[$key]; ?></textarea>
            </div>
            <div class="span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <a href="<?php echo site_url('admin/spravajazykovweb') ?>" class="btn btn-large " >Spat</a>
