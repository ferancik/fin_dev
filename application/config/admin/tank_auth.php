...
$config['email_activation_expire'] = 60*60*24*8;
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = 'kfadmin_autologin';
...
|--------------------------------------------------------------------------
*/
$config['forgot_password_expire'] = 60*15*5;
...
|--------------------------------------------------------------------------
*/
$config['captcha_path'] = 'admin_assets/captcha/';
$config['captcha_fonts_path'] = 'admin_assets/captcha/fonts/5.ttf';
$config['captcha_width'] = 302;
