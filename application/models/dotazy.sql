...
CREATE TABLE tes_account_settings (
...
INSERT INTO tes_accounts (account_id, account_type, account_status, timezone_offset, login_page, swatch, menu_id, username, password) VALUES (1, 'admin', 'active', '0', 'admin_forms', 'green', 1, '', '');

CREATE TABLE tes_client_forms (
  account_id mediumint(8) unsigned NOT NULL,
  form_id mediumint(8) unsigned NOT NULL,
  PRIMARY KEY (account_id,form_id)
);

CREATE TABLE tes_client_views (
  account_id mediumint(8) unsigned NOT NULL,
  view_id mediumint(8) unsigned NOT NULL,
  PRIMARY KEY (account_id,view_id)
);

CREATE TABLE tes_email_template_edit_submission_views (
  email_id mediumint(8) unsigned NOT NULL,
  view_id mediumint(8) unsigned NOT NULL,
  PRIMARY KEY  (email_id,view_id)
);

CREATE TABLE tes_email_template_recipients (
...
CREATE TABLE tes_email_template_when_sent_views (
  email_id mediumint(9) NOT NULL,
  view_id mediumint(9) NOT NULL
);

CREATE TABLE tes_email_templates (
...
CREATE TABLE tes_field_options (
...
CREATE TABLE tes_field_settings (
...
CREATE TABLE tes_field_type_setting_options (
  setting_id mediumint(9) NOT NULL,
...
CREATE TABLE tes_field_type_settings (
...
CREATE TABLE tes_field_type_validation_rules (
...
CREATE TABLE tes_field_validation (
...
CREATE TABLE tes_form_email_fields (
...
INSERT INTO tes_menu_items VALUES (1, 1, 'Forms', 'admin_forms', '', '/admin/forms/', 'no', 'yes', 1);
INSERT INTO tes_menu_items VALUES (2, 1, 'Add Form', 'add_form_choose_type', '', '/admin/forms/add/', 'yes', 'no', 2);
INSERT INTO tes_menu_items VALUES (3, 1, 'Option Lists', 'option_lists', '', '/admin/forms/option_lists/', 'yes', 'no', 3);
INSERT INTO tes_menu_items VALUES (4, 1, 'Clients', 'clients', '', '/admin/clients/', 'no', 'yes', 4);
INSERT INTO tes_menu_items VALUES (5, 1, 'Modules', 'modules', '', '/admin/modules/', 'no', 'yes', 5);
INSERT INTO tes_menu_items VALUES (6, 1, 'Themes', 'settings_themes', '', '/admin/themes/', 'no', 'yes', 6);
INSERT INTO tes_menu_items VALUES (7, 1, 'Settings', 'settings', '', '/admin/settings', 'no', 'yes', 7);
INSERT INTO tes_menu_items VALUES (8, 1, 'Main', 'settings_main', '', '/admin/settings/index.php?page=main', 'yes', 'no', 8);
INSERT INTO tes_menu_items VALUES (9, 1, 'Accounts', 'settings_accounts', '', '/admin/settings/index.php?page=accounts', 'yes', 'no', 9);
INSERT INTO tes_menu_items VALUES (10, 1, 'Files', 'settings_files', '', '/admin/settings/index.php?page=files', 'yes', 'no', 10);
INSERT INTO tes_menu_items VALUES (11, 1, 'Menus', 'settings_menus', '', '/admin/settings/index.php?page=menus', 'yes', 'no', 11);
INSERT INTO tes_menu_items VALUES (12, 1, 'Your Account', 'your_account', '', '/admin/account', 'no', 'yes', 12);
INSERT INTO tes_menu_items VALUES (13, 1, 'Logout', 'logout', '', '/index.php?logout', 'no', 'yes', 13);
INSERT INTO tes_menu_items VALUES (14, 2, 'Forms', 'client_forms', '', '/clients/index.php', 'no', 'yes', 1);
INSERT INTO tes_menu_items VALUES (15, 2, 'Account', 'client_account', '', '/clients/account/index.php', 'no', 'yes', 2);
INSERT INTO tes_menu_items VALUES (16, 2, 'Login Info', 'client_account_login', '', '/clients/account/index.php?page=main', 'yes', 'no', 3);
INSERT INTO tes_menu_items VALUES (17, 2, 'Settings', 'client_account_settings', '', '/clients/account/index.php?page=settings', 'yes', 'no', 4);
INSERT INTO tes_menu_items VALUES (18, 2, 'Logout', 'logout', '', '/index.php?logout', 'no', 'yes', 5);

CREATE TABLE tes_menus (
...
INSERT INTO tes_menus VALUES (1, 'Administrator', 'admin');
INSERT INTO tes_menus VALUES (2, 'Client Menu', 'client');

CREATE TABLE tes_module_menu_items (
...
CREATE TABLE tes_multi_page_form_urls (
  form_id mediumint(8) unsigned NOT NULL,
...
CREATE TABLE tes_new_view_submission_defaults (
  view_id mediumint(9) NOT NULL,
  field_id mediumint(9) NOT NULL,
...
CREATE TABLE tes_public_form_omit_list (
  form_id mediumint(8) unsigned NOT NULL,
  account_id mediumint(8) unsigned NOT NULL,
  PRIMARY KEY  (form_id,account_id)
);

CREATE TABLE tes_public_view_omit_list (
  view_id mediumint(8) unsigned NOT NULL,
  account_id mediumint(8) unsigned NOT NULL,
  PRIMARY KEY  (view_id,account_id)
);

CREATE TABLE tes_sessions (
...
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('program_version', '%FORMTOOLSVERSION%', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('release_date', '%FORMTOOLSRELEASEDATE%', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('release_type', '%FORMTOOLSRELEASETYPE%', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('api_version', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('available_languages', 'en_us,English (US)', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_date_format', 'no', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_footer_text', 'no', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_logout_url', 'yes', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_max_failed_login_attempts', 'no', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_page_titles', 'no', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_sessions_timeout', 'no', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_theme', 'yes', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_timezone_offset', 'yes', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('clients_may_edit_ui_language', 'yes', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_client_menu_id', '2', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_client_swatch', 'green', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_date_field_search_value', 'none', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_date_format', 'M jS y, g:i A', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_footer_text', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_language', 'en_us', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_login_page', 'client_forms', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_logout_url', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_max_failed_login_attempts', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_num_submissions_per_page', '10', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_page_titles', 'Form Tools - {\$page}', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_sessions_timeout', '30', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_theme', 'default', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('default_timezone_offset', '0', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('edit_submission_shared_resources_js', '\$(function() {\r\n  \$(\".fancybox\").fancybox();\r\n});\r\n', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('edit_submission_shared_resources_css', '/* used in the \"Highlight\" setting for most field types */\r\n.cf_colour_red { \r\n  background-color: #990000;\r\n  color: white;\r\n}\r\n.cf_colour_orange {\r\n  background-color: orange; \r\n}\r\n.cf_colour_yellow {\r\n  background-color: yellow; \r\n}\r\n.cf_colour_green {\r\n  background-color: green;\r\n  color: white; \r\n}\r\n.cf_colour_blue {\r\n  background-color: #336699; \r\n  color: white; \r\n}\r\n\r\n/* field comments */\r\n.cf_field_comments {\r\n  font-style: italic;\r\n  color: #999999;\r\n  clear: both;\r\n}\r\n\r\n/* column layouts for radios & checkboxes */\r\n.cf_option_list_group_label {\r\n  font-weight: bold;  \r\n  clear: both;\r\n  margin-left: 4px;\r\n}\r\n.cf_option_list_2cols, .cf_option_list_3cols, .cf_option_list_4cols {\r\n  clear: both; \r\n}\r\n.cf_option_list_2cols .column { \r\n  width: 50%;\r\n  float: left; \r\n}\r\n.cf_option_list_3cols .column { \r\n  width: 33%;\r\n  float: left;\r\n}\r\n.cf_option_list_4cols .column { \r\n  width: 25%;\r\n  float: left;\r\n}\r\n\r\n/* Used for the date and time pickers */\r\n.cf_date_group img {\r\n  margin-bottom: -4px;\r\n  padding: 1px;\r\n}\r\n\r\n', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('edit_submission_onload_resources', '<script src=\"{\$g_root_url}/global/codemirror/js/codemirror.js\"></script>|<script src=\"{\$g_root_url}/global/scripts/jquery-ui-timepicker-addon.js\"></script>|<script src=\"{\$g_root_url}/global/fancybox/jquery.fancybox-1.3.4.pack.js\"></script> |<link rel=\"stylesheet\" href=\"{\$g_root_url}/global/fancybox/jquery.fancybox-1.3.4.css\" type=\"text/css\" media=\"screen\" />', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('field_type_settings_shared_characteristics', 'field_comments:textbox,comments`textarea,comments`password,comments`dropdown,comments`multi_select_dropdown,comments`radio_buttons,comments`checkboxes,comments`date,comments`time,comments`phone,comments`code_markup,comments`file,comments`google_maps_field,comments`tinymce,comments|data_source:dropdown,contents`multi_select_dropdown,contents`radio_buttons,contents`checkboxes,contents|column_formatting:checkboxes,formatting`radio_buttons,formatting|maxlength_attr:textbox,maxlength|colour_highlight:textbox,highlight|folder_path:file,folder_path|folder_url:file,folder_url|permitted_file_types:file,folder_url|max_file_size:file,max_file_size|date_display_format:date,display_format|apply_timezone_offset:date,apply_timezone_offset', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('file_upload_dir', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('file_upload_filetypes', 'bmp,gif,jpg,jpeg,png,avi,mp3,mp4,doc,txt,pdf,xml,csv,swf,fla,xls,tif', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('file_upload_url', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('file_upload_max_size', '200', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('forms_page_default_message', '{\$LANG.text_client_welcome}', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('logo_link', 'http://www.formtools.org', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('min_password_length', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('num_clients_per_page', '10', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('num_emails_per_page', '10', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('num_forms_per_page', '10', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('num_menus_per_page', '10', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('num_modules_per_page', '10', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('num_option_lists_per_page', '10', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('num_password_history', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('program_name', 'Form Tools', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('required_password_chars', '', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('timezone_offset', '0', 'core');
INSERT INTO tes_settings (setting_name, setting_value, module) VALUES ('core_version_upgrade_track', '%FORMTOOLSVERSION%', 'core');

CREATE TABLE tes_themes (
