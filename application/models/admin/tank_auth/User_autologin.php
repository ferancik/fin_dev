...
{
	private $table_name			= 'admin_user_autologin';
	private $users_table_name	= 'admin_users';
	...
	function __construct()
	{
		...
		$this->users_table_name	= $ci->config->item('db_table_prefix', 'admin/tank_auth').$this->users_table_name;
	}
